function letsignore_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
letsignore_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				letsignore_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
letsignore_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
letsignore_xmlhttpRequester.prototype.setupRequestEvent =
